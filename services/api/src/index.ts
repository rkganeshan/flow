...
// This file previously contained an early single-file Fastify server.
// The project now uses the modular entrypoints:
// - `app.ts` (build Fastify instance + register versioned routes)
// - `server.ts` (listen + graceful shutdown)
// - `cli.ts` (service entrypoint)
//
// Keeping `index.ts` as a stub avoids breaking any old imports.
export {};
